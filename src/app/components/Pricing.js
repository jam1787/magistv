...
const pricingData = [
    ...
    {plan: 'Premium', time: '12 meses + 2 grátis', price: '87', description: 'Acceso completo a MagisTV durante 12 meses por un precio promocional. Además, 2 meses adicionales sin costo.'},
]

const Pricing = () => {
  return (
    <section id="pricing" className="flex justify-center items-center flex-wrap text-center text-white">
      {pricingData.map(({plan, time, price, description}) => 
        <div className="h-[21rem] flex flex-col justify-between m-10 px-2 text-center py-5 max-w-72">
          <div>
