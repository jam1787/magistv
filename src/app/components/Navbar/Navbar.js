...
const Navbar = () => {
  ...
  const menuActiveStyles = 'backdrop-blur-sm bg-gradient-to-b from-[#0024d6] 80% to-[#010130ef] 100% top-[0] left-0'

  return (
    <header className='fixed top-0 left-0 z-20 w-full backdrop-blur-sm'>
      <NavMenu
